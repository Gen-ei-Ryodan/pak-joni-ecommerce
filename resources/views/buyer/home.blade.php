        ...
        <section class="section">
            <div class="container">
                <div class="section-header center">
                    <h2 class="section-title-text">Mengapa Memilih JOMOTO</h2>
    ...
    <section class="section">
        <div class="container">
            ...
            <div style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:20px;">
                ...
                <a href="https://wa.me/{{ config('app.whatsapp_number', '6281234567890') }}?text=Halo%20JOMOTO%2C%20saya%20ingin%20konsultasi%20dan%20penawaran%20untuk%20produk%20di%20website%20Anda."
