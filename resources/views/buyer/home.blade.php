                ...
                <div class="contact-col reveal reveal-delay-1">
                    ...
                    <div class="contact-info">
                        <div class="contact-item">
                            <div class="contact-icon-circle" style="background:#222;">
                            ...
                            <div class="contact-item-info">
                                ...
                                <a href="https://wa.me/{{ config('app.social.whatsapp_link') }}?text=Halo%20{{ urlencode(config('app.name')) }}%2C%20saya%20ingin%20konsultasi%20dan%20penawaran." target="_blank" rel="noopener" style="display:inline-block;padding:6px 16px;background:#222;color:#fff;border-radius:6px;font-size:13px;font-weight:500;text-decoration:none;">klik disini</a>
                            </div>
                        </div>
                        <div class="contact-item">
