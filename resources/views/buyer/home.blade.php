                ...
                <div class="contact-col reveal reveal-delay-1">
                    ...
                    <div class="contact-info">
                        <div class="contact-item">
                            <div class="contact-icon-circle" style="background:#25D366;">
                            ...
                            <div class="contact-item-info">
                                <h4>WhatsApp</h4>
                                <p style="font-size:14px;color:#000;margin:2px 0;">{{ config('app.social.whatsapp') }}</p>
                                <p style="font-size:12px;color:#000;margin:0 0 6px;">Hubungi kami via WhatsApp</p>
