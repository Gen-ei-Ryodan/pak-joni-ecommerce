...
use App\Filament\Resources\CsrArticleResource\Pages;
...
class CsrArticleResource extends Resource
{
    protected static ?string $model = CsrArticle::class;
        ...
        return $table
            ...
            ->actions([
                ...
                Actions\Action::make('preview')
                    ->label('Preview')
                    ->icon('heroicon-o-eye')
                    ->url(fn($record) => $record->slug ? route('buyer.csr.show', $record->slug) : '#')
                    ->openUrlInNewTab(),
    ...
    {
        return [
            'index' => Pages\ListCsrArticles::route('/'),
            'create' => Pages\CreateCsrArticle::route('/create'),
            'edit' => Pages\EditCsrArticle::route('/{record}/edit'),
        ];
    }
}
